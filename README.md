...
**API 覆盖率**: OpenHarmony 15/388 (3.9%) | HMS 5/163 (3.1%) | UI组件 12/120 (10%)
...
| F004 | [自定义组件与复用](examples/01_foundation/F004_custom_components) | 🟡 中级 | @Component, @Builder, @BuilderParam | ⏳ 规划中 |
